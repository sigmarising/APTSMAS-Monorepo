...
import { useCenturyTopKOption } from "@/composables/VTrajectoryOLAM/Charts/useCenturyTopKOption";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { t } = useI18n();
    const { handleOption, initOption } = useCenturyTopKOption();
