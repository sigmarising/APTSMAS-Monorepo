...
import { useDecadeTopKOption } from "@/composables/VTrajectoryOLAM/Charts/useDecadeTopKOption";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { t } = useI18n();
    const { handleOption, initOption } = useDecadeTopKOption();
