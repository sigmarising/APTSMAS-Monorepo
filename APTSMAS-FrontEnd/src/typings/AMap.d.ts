...
declare global {
  namespace AMap {
     ...
     */
    export class BezierCurve extends CombinePolyline<
      Required<BezierCurveOptions>
    > {
      _prevZoom: number;
    ...
    export class Bounds {
      ...
      static fromPolygon(
        originPath?: LngLatLike[] | LngLatLike[][]
      ): Bounds | undefined;
      static fromMultiPolygon(
        originPath?: LngLatLike[][][]
      ): Bounds | undefined;
      southWest: LngLat;
      northEast: LngLat;
      className: string;
    ...
    class Map_2 extends CoreMap {
      ...
      setCity(
        cityName: string,
        cbk: (center: number[] | null, zoom: number | null) => void
      ): void;
      /**
